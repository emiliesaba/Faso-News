...
// Footer copyright section 
	...
	$wp_customize->add_panel( 'appointment_copyright_setting', array(
		...
		'title'      => esc_html__('Footer copyright settings', 'vice'),
	) );
    ...
    array(
        'default' => '<p>'.__( '<a href="https://wordpress.org">Proudly powered by WordPress</a> | Theme: <a href="https://webriti.com" rel="nofollow">Vice</a> by Webriti', 'vice' ).'</p>',
...
$wp_customize->add_control(
    'appointment_options[footer_copyright_text]',
    array(
        'label' => esc_html__('Copyright text','vice'),
...
$wp_customize->add_setting(
	...
	'sanitize_callback' => 'vice_sanitize_checkbox',
	'type' => 'option'
));
...
$wp_customize->add_control(
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Hide copyright text','vice'),
        'section' => 'copyright_section_one',
    )
);
	...
	$wp_customize->add_section(
        ...
        array(
            'title' => esc_html__('Social Links','vice'),
           'priority' => 45,
			'panel' => 'appointment_copyright_setting',
        )
    );
    ...
    'appointment_options[footer_social_media_enabled]',
    array(
        'label' => esc_html__('Hide footer social icons','vice'),
    ...
    'appointment_options[footer_social_media_facebook_link]',
    array(
        'label' => esc_html__('Facebook URL','vice'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Open link in new tab','vice'),
        'section' => 'copyright_social_icon',
    )
);
    ...
    'appointment_options[footer_social_media_twitter_link]',
    array(
        'label' => esc_html__('Twitter URL','vice'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    'appointment_options[footer_social_media_linkedin_link]',
    array(
        'label' => esc_html__('LinkedIn URL','vice'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    'appointment_options[footer_social_media_googleplus_link]',
    array(
        'label' => esc_html__('GooglePlus URL','vice'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
   ...
   'appointment_options[footer_social_media_skype_link]',
    array(
        'label' => esc_html__('Skype URL','vice'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    function vice_sanitize_checkbox($checked) {
        // Boolean check.
