...
class Thumbnail {
	...
	public function __construct() {
		...
		add_action( 'admin_action_elementor', [ $this, 'hooks' ], 9 );
	...
	public function hooks() {
		...
		add_filter( 'post_class', [ $this, 'product_has_gallery' ] );

		remove_action( 'woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_product_thumbnail', 10 );

		add_action( 'woocommerce_before_shop_loop_item', [ $this, 'thumbnail_markup_open' ], 8 );
		add_action( 'woocommerce_before_shop_loop_item', 'woocommerce_template_loop_product_thumbnail', 8 );
		add_action( 'woocommerce_before_shop_loop_item', [ $this, 'secondary_product_thumbnail' ], 8 );
		add_action( 'woocommerce_before_shop_loop_item', [ $this, 'thumbnail_markup_close' ], 8 );
