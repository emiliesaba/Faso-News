...
class Responsive_Slider extends \WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'baltic-responsive-slider';
	...
	protected function content_template() {
		...
		<label for="">
			<# if ( data.label ) { #>
				...
				<ul class="baltic-responsive-slider-btns">
			...
			<div class="wrapper">
				<div class="input-field-wrapper desktop active">
					...
					<div class="baltic_range_value">
						<input type="number" data-id='desktop' class="baltic-responsive-range-value-input" value="{{ value_desktop }}" {{{ data.inputAttrs }}} ><#
						if ( data.suffix ) {
						#><span class="baltic-range-unit">{{ data.suffix }}</span><#
						} #>
					</div>
				</div>
				<div class="input-field-wrapper tablet">
					...
					<div class="baltic_range_value">
						<input type="number" data-id='tablet' class="baltic-responsive-range-value-input" value="{{ value_tablet }}" {{{ data.inputAttrs }}} ><#
						if ( data.suffix ) {
						#><span class="baltic-range-unit">{{ data.suffix }}</span><#
						} #>
					</div>
				...
				<div class="input-field-wrapper mobile">
					...
					<div class="baltic_range_value">
						<input type="number" data-id='mobile' class="baltic-responsive-range-value-input" value="{{ value_mobile }}" {{{ data.inputAttrs }}} ><#
						if ( data.suffix ) {
						#><span class="baltic-range-unit">{{ data.suffix }}</span><#
						} #>
					</div>
				</div>
				<div class="baltic-responsive-slider-reset">
