...
class Icons {
	...
	public function __construct() {
		...
		add_filter( 'walker_nav_menu_start_el', [ $this, 'social_menu_icons' ], 10, 4 );
		add_filter( 'nav_menu_link_attributes', [ $this, 'social_link' ], 10, 3 );
		add_filter( 'nav_menu_item_title', 		[ $this, 'dropdown_menu_icons' ], 10, 4 );
