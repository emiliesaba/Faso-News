...
function elementare_custom_settings_register( $wp_customize ) {
	...
	*/	
	...
	'slug'=>'_twitchurl', 
	'default' => '',
	'label' => __('Twitch URL', 'elementare')
	);
	$socialmedia[] = array(
	'slug'=>'_spotifyurl', 
	'default' => '',
	'label' => __('Spotify URL', 'elementare')
	);
	$socialmedia[] = array(
	'slug'=>'_whatsappurl', 
	'default' => '',
	'label' => __('WhatsApp URL', 'elementare')
	);
			...
			?>
				<label>
					...
					<ul class="elementare-icon-list clearfix">
						<div class="elementare-icon-list-search">
							<input id="elementareInputFilter" type="text" placeholder="<?php esc_attr_e('Filter icons...', 'elementare'); ?>">
						</div>
						<?php
						...
						foreach ($elementare_font_awesome_icon_array as $elementare_font_awesome_icon) {
							...
							echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($elementare_font_awesome_icon).'"></i><span class="elementare-hidden-name">'.esc_html($elementare_font_awesome_icon).'</span></li>';
						}
						?>
					</ul>
...
if( ! function_exists('elementare_show_social_network')){
	function elementare_show_social_network($position) {
		...
		$twitchURL = elementare_options('_twitchurl', '');
		$spotifyURL = elementare_options('_spotifyurl', '');
		$whatsappURL = elementare_options('_whatsappurl', '');
		?>
		<div class="<?php echo $position == 'float' ? 'site-social-float' : 'site-social-footer' ?>">
			...
			<?php endif; ?>
			<?php if ($twitchURL) : ?>
				<a class="elementare-social" href="<?php echo esc_url($twitchURL); ?>" target="<?php echo esc_attr($openLinks); ?>" <?php echo esc_attr($attribute); ?> title="<?php esc_attr_e( 'Twitch', 'elementare' ); ?>"><i class="fa fa-twitch spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Twitch', 'elementare' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($spotifyURL) : ?>
				<a class="elementare-social" href="<?php echo esc_url($spotifyURL); ?>" target="<?php echo esc_attr($openLinks); ?>" <?php echo esc_attr($attribute); ?> title="<?php esc_attr_e( 'Spotify', 'elementare' ); ?>"><i class="fa fa-spotify spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Spotify', 'elementare' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($whatsappURL) : ?>
				<a class="elementare-social" href="<?php echo esc_url($whatsappURL); ?>" target="<?php echo esc_attr($openLinks); ?>" <?php echo esc_attr($attribute); ?> title="<?php esc_attr_e( 'WhatsApp', 'elementare' ); ?>"><i class="fa fa-whatsapp spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'WhatsApp', 'elementare' ); ?></span></i></a>
			<?php endif; ?>
		</div>
		<?php
	}
