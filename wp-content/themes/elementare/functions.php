...
function elementare_scripts() {
	...
	if (is_page_template('template-onepage.php')) {
		wp_enqueue_style( 'elementare-onepage', get_template_directory_uri() .'/css/onepage.min.css', array(), wp_get_theme()->get('Version'));
	}
	if ( class_exists( 'WooCommerce' ) ) {
		wp_enqueue_style( 'elementare-woocommerce', get_template_directory_uri() .'/css/woocommerce.min.css', array(), wp_get_theme()->get('Version'));
	}
...
*/
function elementare_skip_link_focus_fix() {
...
add_action( 'wp_print_footer_scripts', 'elementare_skip_link_focus_fix' );
